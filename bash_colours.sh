...
# echo -en "${Bold}${Blue}${OnWhite}bold blue text on white background${Rst}"; sleep 3; echo "${RESET_LINE}${Red}${OnYellow}becomes red text on yellow background${Rst}"

echo -e "testing ${Bla}black${RCol} .. ${OnIRed}${Black}IRED!${Rst}"
